...
export function AddFolderDialog({
  ...
  return (
    ...
    >
      <DialogContent className="fixed inset-x-0 bottom-0 top-auto mx-auto flex max-h-[90dvh] w-full max-w-xl flex-col overflow-hidden rounded-t-3xl border-t border-border/70 bg-background/95 p-0 shadow-2xl backdrop-blur-xl sm:inset-auto sm:left-1/2 sm:top-1/2 sm:max-h-[85dvh] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-3xl sm:border">
          ...
          <DialogFooter className="mt-6">
            {phase === "input" ? (
              <>
                ...
                <Button type="button" variant="ghost" onClick={() => void handlePaste()}>
