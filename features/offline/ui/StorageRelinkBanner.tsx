...
export function StorageRelinkBanner() {
  ...
  const needsGesture = handleStatus === "requires-gesture";
            ...
            >
              ...
              <div className="min-w-0 flex-1 pt-0.5">
                <p className="text-[13px] font-semibold tracking-tight text-amber-900 dark:text-amber-200">
                  {needsGesture ? "Offline storage needs re-authorization" : "Offline storage disconnected"}
                </p>
                ...
                <div className="mt-3 flex items-center gap-2.5">
                  ...
                  >
                    ...
                    {needsGesture ? "Re-authorize Folder" : "Relink Folder"}
                  </Button>
                </div>
              </div>
              <button
