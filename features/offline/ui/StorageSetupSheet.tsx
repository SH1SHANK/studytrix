...
export function StorageSetupSheet({
  ...
  const handleStatus = useStorageLocationStore((s) => s.handleStatus);
          ...
          {step === "relink" && (
            ...
            >
              <DialogHeader>
                ...
                <DialogDescription>
                  {handleStatus === "requires-gesture"
                    ? "Storage permission needs to be granted again. Select your folder to re-authorize access."
                    : "We couldn't find your previous offline files. Select your existing folder to restore access."}
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="space-y-2">
                <OptionCard
                  icon={IconRefresh}
                  title={handleStatus === "requires-gesture" ? "Re-authorize Folder" : "Relink Existing Folder"}
                  description={
                    handleStatus === "requires-gesture"
                      ? "Select your existing offline folder to restore write permission."
                      : "Select the folder you previously used for offline storage."
                  }
