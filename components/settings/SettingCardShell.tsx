...
export function SettingRowShell({
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-3 py-4 border-b border-border/60 last:border-0 border-border/60 sm:flex-row sm:items-center sm:justify-between sm:gap-4",
    ...
    >
      <div className="min-w-0 space-y-1">
        <h3
          className={cn(
            "text-[1.05rem] leading-tight font-medium text-foreground",
        ...
        {description ? (
          <p className="text-[13px] leading-snug text-muted-foreground max-w-2xl">
            {description}
          </p>
        ) : null}
        {requiresRestart ? (
